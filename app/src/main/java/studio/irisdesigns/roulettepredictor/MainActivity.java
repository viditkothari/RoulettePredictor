...
public class MainActivity extends AppCompatActivity {
    ...
    private static int previousWinningNumber;
    ...
    private static int[][] P4 = {{26, 32}, {20, 33}, {21, 25}, {35, 26}, {19, 21}, {24, 10}, {34, 27}, {29, 28}, {23, 30}, {22, 31}, {5, 23}, {30, 36}, {28, 35}, {36, 27}, {31, 20}, {32, 19}, {33, 24}, {25, 34}, {22, 29}, {15, 4}, {14, 1}, {2, 4}, {18, 9}, {10, 8}, {16, 5}, {2, 17}, {3, 0}, {6, 13}, {7, 12}, {7, 18}, {8, 11}, {9, 14}, {0, 15}, {1, 16}, {17, 6}, {12, 3}, {11, 13}};
    ...
    int[] groupPA1 = new int[4];
    int[] groupR1 = new int[4];
    int[] groupPB1 = new int[4];

    // Total Loss & Last Loss counter Number
    int[][] groupPA2 = new int[4][2];
    int[][] groupR2 = new int[4][2];
    int[][] groupPB2 = new int[4][2];

    // Loss Percentage
    double[] groupPA3 = new double[4];
    double[] groupR3 = new double[4];
    double[] groupPB3 = new double[4];
    ...
    public void undo() {
        if (spinCounter >= 1) {
            ...
            // Doing getLinkPrev twice because on each Prediction round, the AsyncTask code **already** increments/points the node's location to the next node in the list.
            // So, Node: ('t'+1-1-1) will give ('t-1')
            ...
            String status = "Spin #: " + df.format(spinCounter) + " · Win #: " + df.format(currentWinningNumber);
    ...
    public void reset() {
        ...
        currentLoopCounter = loopCounter.get(0);
